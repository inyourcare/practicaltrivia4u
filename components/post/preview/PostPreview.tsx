...
const PostPreview = (props: PostMetadata) => {
  return (
    <div
      className={` text-[rgba(35,46,82,1)]  transition-all border boder-gray-100 p-5`}
    >
      <div className="inline-flex my-3 flex-col sm:flex-col md:flex-col lg:flex-row xl:flex-row 2xl:flex-row justify-start  items-center">
        <Image
          src={props.image}
          width={300}
          height={210}
          alt={props.imageAlt}
          className={`rounded-lg bg-cover bg-no-repeat bg-center w-full max-w-[300px] sm:w-full md:w-full  lg:w-[300px] xl:w-[300px] 2xl:w-[300px] h-[210px] transition-all`}
        />
        <div className="min-h-[10px] lg:min-h-[0px]"></div>
        <div className="gap-3 px-0 sm:px-0 md:px-0 lg:px-3  xl:px-3  2xl:px-3  flex flex-col  items-start w-6/6 sm:w-6/6 md:w-[610px] lg:w-[610px] xl:w-[610px] 2xl:w-[950px] lg:ml-10">
