    ...
    <div className="w-full">
      ...
      >
        <Image
          ...
          src={`/images/ask/booking/banner-yellow.png`}
          alt=""
        />
      </div>
          ...
          <div className={"w-full h-10 flex flex-row-reverse items-end mt-5"}>
            <button
              className={
                ...
                " rounded-xl bg-yellow-200 boder border-yellow-400 hover:bg-yellow-400 p-2 min-w-[90px] justify-center items-center border text-xs font-bold " +
                "max-h-[80px] h-10"
